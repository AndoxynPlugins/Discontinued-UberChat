...
public class ChatChecker {
	...
	public ChatChecker() {
		...
		swearChecker.addAnwhereSwearWord("fuck");
		swearChecker.addAnwhereSwearWord("nigger");
		swearChecker.addAnwhereSwearWord("bitch");
		swearChecker.addAnwhereSwearWord("shit");
		swearChecker.addAnwhereSwearWord("crap");
		swearChecker.addAnwhereSwearWord("fag");
		swearChecker.addAnwhereSwearWord("dick");
		swearChecker.addAnwhereSwearWord("cunt");
		swearChecker.addAnwhereSwearWord("cock");
		swearChecker.addWordOnlySwearWord("ass");
	}

	public ChatChecker(SwearChecker swearChecker) {
		this.swearChecker = swearChecker;
	}
